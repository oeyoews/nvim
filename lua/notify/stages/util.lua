...
local function window_intervals(windows, direction, cmp)
  ...
  for _, w in pairs(windows) do
    ...
    if exists then
      local slot_key = (direction == M.DIRECTION.LEFT_RIGHT or direction == M.DIRECTION.RIGHT_LEFT) and "col" or "row"
      local space_key = (direction == M.DIRECTION.LEFT_RIGHT or direction == M.DIRECTION.RIGHT_LEFT) and "width"
        or "height"
